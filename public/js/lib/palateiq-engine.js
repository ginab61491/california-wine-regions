...
exports.calculateAdaptiveElo = calculateAdaptiveElo;
exports.eloToLevel = eloToLevel;
exports.levelEloRange = levelEloRange;
...
exports.cardWeight = cardWeight;
exports.selectCard = selectCard;
exports.getCardAtIndex = getCardAtIndex;
exports.processAnswer = processAnswer;
exports.checkAnswer = checkAnswer;
exports.checkPairsAnswer = checkPairsAnswer;
exports.createDefaultStats = createDefaultStats;
exports.resetDailyCount = resetDailyCount;
exports.getAccuracy = getAccuracy;
exports.getDomainAccuracy = getDomainAccuracy;
exports.getDomainSummary = getDomainSummary;
exports.cardCountsByLevel = cardCountsByLevel;
exports.cardCountsByDomain = cardCountsByDomain;
exports.unseenCards = unseenCards;
exports.answersToNextLevel = answersToNextLevel;
// ── Constants ───────────────────────────────────────────
const MAX_LEVEL = 11;
 ...
 */
function expectedScore(playerElo, cardDifficulty) {
 ...
 */
function calculateElo(playerElo, cardDifficulty, won, K = DEFAULT_K) {
 ...
 */
function calculateAdaptiveElo(playerElo, cardDifficulty, won, totalAnswered) {
 ...
 */
function getLevelInfo(elo, cards) {
 ...
 */
function filterCards(cards, domain, level) {
    let pool = cards;
 ...
 *                      Default 200.
 */
function cardWeight(playerElo, cardDifficulty, spreadFactor = 200) {
 ...
 */
function selectCard(cards, stats, domain = 'all', level = 0) {
 ...
 */
function getCardAtIndex(cards, index, domain = 'all', level = 0) {
    const pool = filterCards(cards, domain, level);
    if (pool.length === 0)
        return null;
 ...
 */
function processAnswer(card, correct, stats) {
 ...
 */
function checkAnswer(card, selectedIndex) {
 ...
 */
function checkPairsAnswer(card, userMatches) {
 ...
 */
function resetDailyCount(stats) {
 ...
 */
function getDomainAccuracy(stats, domain) {
 ...
 */
function getDomainSummary(stats) {
    const domains = [
 ...
 */
function cardCountsByLevel(cards) {
    const counts = {};
 ...
 */
function cardCountsByDomain(cards) {
    const counts = {};
    for (const c of cards) {
 ...
 */
function unseenCards(cards, stats, domain, level) {
    const pool = filterCards(cards, domain, level);
    const seenSet = new Set(stats.seenIds);
 ...
 */
function answersToNextLevel(stats, averageCardDifficulty) {
...
//# sourceMappingURL=palateiq-engine.js.map