...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderHome(c) {
    ...
    c.innerHTML = `
      <div class="lu-hero">
        <img class="lu-hero-img" src="https://images.unsplash.com/photo-1553361371-9b22f78e8b1d?w=800&h=300&fit=crop&crop=center" alt="A lineup of wine bottles" loading="lazy">
      </div>
